...
export default function App() {
  ...
  const uploadGraph = useRef<(src: string) => void>();
  ...
  return (
    <>
      ...
      <div className="my-10 flex w-full justify-center">
        <button
          className="rounded-md border-2 border-primary-400 p-2 hover:bg-primary-200"
          onClick={log}
        >
          Log editor content
        </button>
